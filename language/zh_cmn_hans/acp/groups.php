...
$lang = array_merge($lang, array(
	...
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> '这个设置会覆盖用户的短信限制。所有用户组的最大值将决定实际值。<br />如果设成0将使用全局设定中的默认设置来覆盖该组用户的设置。',
	...
	'GROUP_MAX_RECIPIENTS_EXPLAIN'  => '单个私人短信允许发送的收件人数量上限。用户组的最大值将决定实际值。<br />如果设成0将使用全局设定中的默认设置来覆盖该组用户的设置。',
