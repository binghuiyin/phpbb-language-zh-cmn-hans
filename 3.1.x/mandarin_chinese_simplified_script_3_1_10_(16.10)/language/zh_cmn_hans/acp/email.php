...
$lang = array_merge($lang, array(
	'ACP_MASS_EMAIL_EXPLAIN'		=> '这里您可以给所有的用户或者某个用户组的用户发送 email 。 发送时，将会先往管理员的邮箱中发送一份拷贝，同时也 CC 到其他收信人的邮箱中。 默认设置是每个邮件只包含二十个收件人，更多收件人的话会发送多个邮件。 如果您要给很多人发送 email，当提交后请耐心等待而不要动这个页面。一般群发需要很长一段时间，当结束的时候会提示您。',
	'ALL_USERS'						=> '所有用户',
