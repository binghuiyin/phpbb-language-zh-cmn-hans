...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> '您已经将您的论坛成功转换为 phpBB 3.1，您现在可以登录并<a href="../">访问您的论坛</a>。请在开启新论坛前确认参数都已经正确设置，并删除了install安装目录。别忘了phpBB的在线使用帮助有<a href="https://www.phpbb.com/support/docs/en/3.1/ug/">文档</a>和<a href="https://www.phpbb.com/community/viewforum.php?f=466">支持论坛</a>。',
